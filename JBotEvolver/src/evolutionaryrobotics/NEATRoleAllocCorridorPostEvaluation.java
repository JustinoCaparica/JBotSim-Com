...
public class NEATRoleAllocCorridorPostEvaluation {
    ...
    public NEATRoleAllocCorridorPostEvaluation(String[] args, String[] extraArgs) {
        this(args);
        this.args = extraArgs;
    }

    public NEATRoleAllocCorridorPostEvaluation(String[] args) {
        for (String s : args) {
            String[] a = s.split("=");
            if (a[0].equals("dir")) {
                dir = a[1];
