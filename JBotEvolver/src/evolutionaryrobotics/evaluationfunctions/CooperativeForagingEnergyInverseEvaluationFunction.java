...
public class CooperativeForagingEnergyInverseEvaluationFunction extends EvaluationFunction{
    ...
    public CooperativeForagingEnergyInverseEvaluationFunction(Arguments args) {
            super(args);	
    ...
    public double getFitness() {
        //return  ( 1.0 * preysCaptured / preys ) / spentEnergy;
        //return 1.0 / ( 1 + spentEnergy );
        return ( 1 + spentEnergy );
    }
