...
public class CooperativeForagingTimeExponentialEvaluationFunction extends EvaluationFunction{
    ...
    public CooperativeForagingTimeExponentialEvaluationFunction(Arguments args) {
            super(args);	
    ...
    public double getFitness() {
        ...
        timePenalty = ( 0.85 * timePenalty) * ( (1.0 * timeStep) / (totalSteps) );
