 ...
 * a BroadcasPreyActuator of another robot
 * @author guest
 */
public class BroadcastPreySensor extends ConeTypeSensor {
...
//                                            //this sensor
    ...
    public BroadcastPreySensor( Simulator simulator, int id, Robot robot, Arguments args ) {
    ...
    protected double calculateContributionToSensor( int i, PhysicalObjectDistance source ) {
        ...
        if ( !source.getObject().getType().equals( PhysicalObjectType.ROBOT )) {
            System.out.println("BroadcastPreySensor:" + " source is NOT a robot. It should be.");
        ...
        if ((sensorInfo.getDistance() < getCutOff())
            ...
            BroadcastPreyActuator act;
            act = (BroadcastPreyActuator) ((Robot) source.getObject()).getActuatorByType( BroadcastPreyActuator.class );
