 ...
 * a BroadcasNestActuator of another robot
 * @author guest
 */
public class BroadcastNestSensor extends ConeTypeSensor {
...
//                                            //this sensor
    ...
    public BroadcastNestSensor( Simulator simulator, int id, Robot robot, Arguments args ) {
    ...
    protected double calculateContributionToSensor( int i, PhysicalObjectDistance source ) {
        ...
        if ( !source.getObject().getType().equals( PhysicalObjectType.ROBOT )) {
            System.out.println("BroadcastNestSensor:" + " source is NOT a robot. It should be.");
        ...
        if ((sensorInfo.getDistance() < getCutOff())
                ...
                && (sensorInfo.getAngle() > (-openingAngle / 2.0))) {
                        ...
                        BroadcastNestActuator act;
            act = (BroadcastNestActuator) ((Robot) source.getObject()).getActuatorByType( BroadcastNestActuator.class );
